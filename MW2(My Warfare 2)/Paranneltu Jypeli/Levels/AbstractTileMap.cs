...
namespace Jypeli
{
    ...
    {
        public delegate void TileMethod( Vector position, double width, double height, IntPoint positionInLevelArray);
        public delegate void TileMethod<T1>(Vector position, double width, double height, IntPoint positionInLevelArray, T1 p1);
        public delegate void TileMethod<T1, T2>(Vector position, double width, double height, IntPoint positionInLevelArray, T1 p1, T2 p2);
        public delegate void TileMethod<T1, T2, T3>(Vector position, double width, double height, IntPoint positionInLevelArray, T1 p1, T2 p2, T3 p3);
        public delegate void TileMethod<T1, T2, T3, T4>(Vector position, double width, double height, IntPoint positionInLevelArray, T1 p1, T2 p2, T3 p3, T4 p4);
        public delegate void TileMethod<T1, T2, T3, T4, T5>(Vector position, double width, double height, IntPoint positionInLevelArray, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5);
        public delegate void TileMethod<T1, T2, T3, T4, T5, T6>(Vector position, double width, double height, IntPoint positionInLevelArray, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6);
        ...
        struct TileMethodCall
        {
            ...
            public void Invoke( double tileWidth, double tileHeight )
            {
                ...
                method( new Vector( realX, realY ), tileWidth, tileHeight, new IntPoint(row, col));
            }
        }
        ...
        {
            legend[tileSymbol] = delegate( Vector p, double w, double h, IntPoint posInLevel ) { f( p, w, h, posInLevel, p1 ); };
        }
        ...
        {
            legend[tileSymbol] = delegate(Vector p, double w, double h, IntPoint posInLevel) { f(p, w, h, posInLevel, p1, p2); };
        }
        ...
        {
            legend[tileSymbol] = delegate(Vector p, double w, double h, IntPoint posInLevel) { f(p, w, h, posInLevel, p1, p2, p3); };
        }
        ...
        {
            legend[tileSymbol] = delegate(Vector p, double w, double h, IntPoint posInLevel) { f(p, w, h, posInLevel, p1, p2, p3, p4); };
        }
        ...
        {
            legend[tileSymbol] = delegate(Vector p, double w, double h, IntPoint posInLevel) { f(p, w, h, posInLevel, p1, p2, p3, p4, p5); };
        }
        ...
        {
            legend[tileSymbol] = delegate(Vector p, double w, double h, IntPoint posInLevel) { f(p, w, h, posInLevel, p1, p2, p3, p4, p5, p6); };
        }
            ...
            for ( int y = height - 1; y >= 0; y-- )
            {
                for ( int x = 0; x < width; x++ )
                {
                    ...
                    if ( method != null )
                    {
                        ...
                        method( new Vector( realX, realY ), tileWidth, tileHeight, new IntPoint(x, y));
                    }
                }
            }
        }
        ...
        public void Optimize( TileType sym )
        {
            ...
            for ( int row = 0; row < RowCount; row++ )
            {
                for ( int col = 0; col < ColumnCount; col++ )
                {
                    ...
                    if ( w > 0 && h > 0 )
                    {
                        TileMethod newMethod = delegate (Vector oldPos, double oldWidth, double oldHeight, IntPoint oldPosInLevel)
                        {
                            ...
                            method( newPos, oldWidth * w, oldHeight * h, new IntPoint(row, col));
                        };
        ...
        {
            return new TileMethod( delegate( Vector p, double w, double h, IntPoint posInLevel ) { m( p, newWidth, newHeight, posInLevel); } );
        }
        ...
        {
            return new TileMethod( delegate( Vector p, double w, double h, IntPoint posInLevel) { m( p, w * widthMultiplier, h * heightMultiplier, posInLevel ); } );
        }
    }
}
