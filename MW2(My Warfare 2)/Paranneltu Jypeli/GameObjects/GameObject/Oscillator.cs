...
namespace Jypeli.GameObjects
{
    ...
    internal class LinearOscillator : Oscillator
    {
            ...
            : base( obj, f, phase, damping )
        {
            ...
            if ( Object is PhysicsObject )
            {
                ( (PhysicsObject)obj ).Velocity = Axis * Amplitude * 2 * Math.PI * f * Math.Cos( phase );
            }
        }
        ...
        {
            return obj is PhysicsObject && !double.IsInfinity( ( (PhysicsObject)obj ).Mass );
        }
        ...
        protected override void Apply()
        {
            if ( IsDynamic( Object ) )
            {
                PhysicsObject physObj = (PhysicsObject)Object;
        ...
        public override void Stop()
        {
            if ( Object is PhysicsObject )
            {
                ( (PhysicsObject)Object ).StopAxial( Axis );
            }
        }
    }
    ...
    internal class AngularOscillator : Oscillator
    {
            ...
            : base( obj, f, 0, damping )
        {
            ...
            if ( Object is PhysicsObject )
            {
                ( (PhysicsObject)obj ).AngularVelocity = Direction * 2 * Amplitude.Radians * f;
            }
        }
        ...
        bool IsDynamic( IGameObject obj )
        {
            return obj is PhysicsObject && !double.IsInfinity( ( (PhysicsObject)obj ).MomentOfInertia );
        }
        ...
        public override void Stop()
        {
            if ( Object is PhysicsObject )
            {
                ( (PhysicsObject)Object ).StopAngular();
            }
        }
    }
}
